...
$username = $_SESSION['email'];
   $sql="select * from turf where owner_email='$username' AND active=0" ;
   $res=select_data($sql);
                    ...
                    <div class="grids5-info">
                        ...
                        <div class="blog-info card-body blog-details">
                            <div class="d-flex align-items-center justify-content-between">
                                <a href="#author" class="post"><i class="fas fa-user"></i> </b> <?php echo $row['email']; ?></a>
...
<td>
    <a href="../../php/reject.php?email=<?php echo $row['email']; ?>" class="btn btn-danger">Reject</a>
</td>
                        </div>
                    </div>
                </div>
